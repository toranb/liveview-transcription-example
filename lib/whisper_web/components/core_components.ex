defmodule WhisperWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WhisperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WhisperWeb.Gettext, "errors", msg, opts)
    end
  end
